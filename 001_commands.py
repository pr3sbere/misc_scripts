...
domain = "domain.com"   # Replace with your desired domain
...
commands = {
    ...
    "UV": [
        ...
        "Update the current shell: uv tool update-shell",
        "Update the global shell: source ~/.bashrc",
        "Install a tool: uv tool install <tool_or_GIT_repository>",
        "List the installed tools: uv tool list",
        "Remove a tool: uv tool uninstall <tool_or_GIT_repository>",
    ],
    "mitm6": [
